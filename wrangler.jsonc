...
// atiende /api/analizar-factura, que manda la foto/PDF de la
// factura del proveedor a Claude para extraer los productos.
//
...
//
// Te pedirá pegar la clave. Se consigue en console.anthropic.com
// (Settings → API Keys). Es DISTINTA a tu cuenta normal de Claude.
// ============================================================
